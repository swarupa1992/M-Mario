...
function setup() {
  ...
  ground = createSprite(width/2,height-40,width,100);//height-38
  ground.addImage("ground",groundImage);
  ground.x = ground.width /2;
  ground.scale = 1.6;
  
  invisibleGround = createSprite(width/2,height-83,width,45);
...
function spawnObstacles(){
 ...
 if (frameCount % 60 === 0){
   ...
   obstacle = createSprite(width+10,height-95,10,40);//165
   obstacle.velocityX = -( 10+ score/10);
   
    obstacle.y = Math.round(random(height-300,height-250));//180,250
...
function spawnBricks() {
 ...
 if (frameCount % 50 === 0) {
    ...
    brick.y = Math.round(random(height-300,height-250));//160,200
